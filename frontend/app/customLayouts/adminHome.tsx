...
const navigation = [
  { name: 'Home', href: '/admin/dashboard', icon: HomeIcon, current: true }, // current is making the highlight of the nav bar
  {
    name: 'My tasks',
...
const pinnedProjects = projects.filter((project) => project.pinned); /// Pined Project
console.log(pinnedProjects); /// Need to pass a props
                ...
                <Dialog.Panel className="relative flex w-full max-w-xs flex-1 flex-col bg-white pt-5 pb-4">
                  ...
                  <div className="flex flex-shrink-0 items-center px-4">
                    <img
                      ...
                      src="https://tailwindui.com/img/logos/mark.svg?color=purple&shade=500" // logo
                      alt="Your Company" // my page name
                    />
                  </div>
